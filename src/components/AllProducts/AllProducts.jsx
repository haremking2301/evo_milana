...
import { deleteReducer, filterReducer } from '../../redux/reducers/filterSlice';
...
function AllProducts() {
    ...
    const params = useSelector((state) => state.filterProducts.params)
    ...
    return (
        <div>
            ...
            <div className='z-30 sticky top-0 lg:max-w-[1100px] md:max-w-[700px] sm:max-w-[520px] mx-auto mt-[50px] text-center'>
                <div className='bg-white flex flex-wrap justify-between mt-[20px] border-[1px] border-color-header py-[5px]'>
                        <Space wrap>
                            <Select
                        ...
                        <button onClick={handleDeleteFilter} className='text-[14px] px-[40px] border-[1px] rounded-md border-cyan-50 hover:border-[#c64d5f]'>Bỏ lọc <RiFilterOffLine className='float-right ml-[10px] mt-[2px]'></RiFilterOffLine></button>
                </div>
            </div>
            <div className='flex flex-wrap lg:max-w-[1120px] md:max-w-[720px] sm:max-w-[540px] mx-auto text-center relative mb-[30px]'>
                {(allProducts.length !== 0)? allProducts.map(function(product, index) {
                    return (
                ...
                }) : <div className='text-center w-[98%] mx-auto mt-[10px] py-[20px] text-[14px] bg-[#fff3cd]'>Không có sản phẩm phù hợp</div>}
